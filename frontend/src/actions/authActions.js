...
export const registerUser = (userData, history) => dispatch => {
  axios
    .post("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/register", userData)
...
export const loginUser = userData => dispatch => {
  axios
    .post("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/login", userData)
    .then(res => {

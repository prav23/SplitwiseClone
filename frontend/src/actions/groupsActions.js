...
export const updateGroup = (groupData, history) => dispatch => {
  axios
    .put("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/groups", groupData)
...
export const createGroup = (groupData, history) => dispatch => {
    axios
      .post("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/groups", groupData)
      .then(res => {
        const userGroupData = {
          ...
          axios.post("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/usergroups", userGroupData);
          axios.post("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/userfriends", userGroupData)
          .then( res => history.push("/dashboard"))

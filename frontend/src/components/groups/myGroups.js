...
class MyGroups extends Component {
  ...
  render() {
    ...
    const handleLeaveGroup = ( group_id ) => {
      ...
      axios.delete(`http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/usergroups/${group_id}/${user.user_id}`);
    ...
    const handleAcceptInvite = ( group_id ) => {
      ...
      axios.put("http://ec2-52-15-69-100.us-east-2.compute.amazonaws.com:3001/api/usergroups/groupinvite", inviteUserGroupData);
      const ln = this.props.getGroupsDetails;
      setTimeout(() => ln(user.user_id), 2000);
    }
    if (groupsLoading) {
